...
function Contact() {
  ...
  return (
    <div className={`flex flex-col w-full items-center px-4 py-12 text-center sm:px-8 ${sectionClass}`}>
      <h1 className={`text-3xl font-bold sm:text-4xl ${titleClass}`}>{title}</h1>
      <p className={`mt-4 max-w-xl font-light text-sm whitespace-pre-line ${bodyClass}`}>{description}</p>
      <a href={`mailto:${email}`} className={`mt-4 font-extralight text-sm underline break-all ${linkClass}`}>
        {email}
      </a>
      <div className="mt-4 flex flex-wrap justify-center gap-4">
        <a href="https://www.linkedin.com/in/mertsaydan/" target="_blank" className={`font-light text-sm underline ${linkClass}`}>
          <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" aria-hidden="true">
            <path fillRule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
          </svg>
        </a>
        <a href="https://github.com/mertsaydan" target="_blank" className={`font-light text-sm underline ${linkClass}`}>
          <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <a href="https://twitter.com/mertsaydan" target="_blank" className={`font-light text-sm underline ${linkClass}`}>
          <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <a href="https://www.instagram.com/mertsaydan/" target="_blank" className={`font-light text-sm underline ${linkClass}`}>
          <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" aria-hidden="true">
